...
st.set_page_config(layout="wide", page_title='QuantMind', page_icon='C:/Users/marci/qmind/venv/assets/favicon.ico',)

st.image("https://www.pythonanywhere.com/user/qmind/files/home/qmind/img/logo.png", width=150)

st.markdown('<style>' + open('./style.css').read() + '</style>', unsafe_allow_html=True)



df= pd.read_csv("C:/Users/marci/qmind/venv/tabela.csv")
vale=df.loc[[0]]
petr4=df.loc[[1]]
itub4=df.loc[[2]]
bbdc4=df.loc[[3]]
...
with st.sidebar:
        st.header(':violet[IBrX-50:]')
        tabs = on_hover_tabs(tabName=['VALE3', 'PETR4', 'ITUB4','BBDC4','B3SA3', 'ABEV3', 'JBSS3',  'BBAS3', 'SUZB3', 'GGBR4', 'SBSP3', 'MGLU3',
                         ...
                         iconName=['chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart', 'chart',
                                   'chart', 'chart', 'chart', 'chart', 'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	
                                   'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	
                                   'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	
                                   'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart', 	'chart'], default_choice=0)
